...
const BenefitsSection = () => {
  return (
    <section className="py-24 relative overflow-hidden" aria-labelledby="benefits-title">
      <div className="container mx-auto px-4">
        <h2 id="benefits-title" className="text-4xl md:text-5xl font-serif text-center mb-16 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {benefits.map((benefit, index) => (
            <div 
              ...
              role="article"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-primary/10 to-transparent rounded-2xl -z-10" aria-hidden="true" />
              ...
              <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
                {benefit.icon}
              </div>
